...
open(F, "/media/lamiaa/E8968BF8968BC612/mediaDrive/congestionControl/torN23_updated/src/or/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/media/lamiaa/E8968BF8968BC612/mediaDrive/congestionControl/torN23_updated/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/media/lamiaa/E8968BF8968BC612/mediaDrive/congestionControl/torN23_updated/doc/tor.1.txt") or die;
while (<F>) {
