...
#define RELAY_COMMAND_E2ECREDIT 41

//Ochir_E2E2 - Algorithm-2: TCP-inspired end-to-end flow control
#define RELAY_COMMAND_E2ESTOPSENDING 42
#define RELAY_COMMAND_E2ESTARTSENDING 43
...
#define CIRCWINDOW_START_MIN 1000
...
//Ochir_E2E - Algorithm-1: credit based end-to-end flow control
#define STREAME2E_START 20
#define STREAME2E_INCREMENT 50000
#define STREAME2E_RECV_MAX 50000
#define STREAME2E_TAB_MAX 100000
...
typedef struct circuit_t {
  ...
  //mashael_N23
    ...
    //Ochir_E2E - Algorithm-1: credit based end-to-end flow control
    int e2e_credit_balance_n[STREAME2E_TAB_MAX];
    int e2e_recv_data_n[STREAME2E_TAB_MAX];
    int e2e_enough_recv_n[STREAME2E_TAB_MAX];
} circuit_t;
...
typedef struct or_circuit_t {
  ...
  //mashael_N23
    ...
    //Ochir_E2E - Algorithm-1: credit based end-to-end flow control
    int e2e_credit_balance_p[STREAME2E_TAB_MAX];
...
/*  double PathsNeededToBuildCircuits;
  ...
  * If set, use these main (currently v3) directory authorities and
   * not the default ones.
  config_line_t *DirAuthority;*/



  //Ochir_E2E
  // if 1 use Algorithm-1: credit based end-to-end flow control
  // if 1 UseE2E2 should be 0
  int UseE2E;

  //Ochir_E2E2
  // if 1 use Algorithm-2: TCP-inspired end-to-end flow control
  // if 1 UseE2E should be 0
  int UseE2E2;
